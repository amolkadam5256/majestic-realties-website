...
const ArchitecturalExpert = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        {/* Primary Meta Tags */}
        <title>Real Estate Financial Expert in Pune | Home Loan & Investment Guidance | Majestic Realties</title>
        <meta name="description" content="Get professional financial guidance for real estate investments, home loans, EMI planning, and budget evaluation with Majestic Realties. Our financial experts help buyers make smart, secure, and profitable property decisions in Pune." />
        <meta name="keywords" content="Real estate financial expert Pune, Property investment guidance, Majestic Realties financial expert" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.majesticrealties.com/financial-expert" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Real Estate Financial Expert in Pune | Home Loan & Investment Guidance | Majestic Realties" />
        <meta property="og:description" content="Get professional financial guidance for real estate investments, home loans, EMI planning, and budget evaluation with Majestic Realties. Our financial experts help buyers make smart, secure, and profitable property decisions in Pune." />
        <meta property="og:url" content="https://www.majesticrealties.com/financial-expert" />
        <meta property="og:site_name" content="Majestic Realties" />
        <meta property="og:image" content="https://www.majesticrealties.com/assets/images/financial-expert-banner.jpg" />
        <meta property="og:image:alt" content="Financial Expert Guidance for Real Estate in Pune | Majestic Realties" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Real Estate Financial Expert in Pune | Home Loan & Investment Guidance | Majestic Realties" />
        <meta name="twitter:description" content="Get professional financial guidance for real estate investments, home loans, EMI planning, and budget evaluation with Majestic Realties. Our financial experts help buyers make smart, secure, and profitable property decisions in Pune." />
        <meta name="twitter:image" content="https://www.majesticrealties.com/assets/images/financial-expert-banner.jpg" />
        <meta name="twitter:site" content="@MajesticRealties" />
        <meta name="twitter:creator" content="@MajesticRealties" />

        {/* Additional SEO Tags */}
        <meta name="author" content="Majestic Realties" />
