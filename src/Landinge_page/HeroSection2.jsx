  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full lg:w-1/2 text-left text-white space-y-6">
        <h2 className="text-1xl md:text-2xl font-extrabold text-yellow-400 drop-shadow-lg leading-tight">
          “The Best Investment on Earth is Owning Land”
        </h2>
        <h1 className="text-4xl md:text-5xl font-bold">
          Welcome to{" "}
          <span className="text-yellow-300">Mount Castle – Farmhouse & Bungalow Plots, Ambedwet</span>
        </h1>
        <p className="text-md md:text-lg text-gray-200">
          Discover premium <strong>farmhouse and bungalow plots in Ambedwet, Pirangut, Pune</strong>.
          Nestled on a serene hilltop tableland with breathtaking panoramic views,
          Mount Castle is your perfect destination for a <em>lifestyle upgrade, smart investment,
            and nature-inspired living</em>. Limited inventory – secure your dream plot today!
        </p>
