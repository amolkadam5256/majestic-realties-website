...
const LegalExpert = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        {/* Page Title */}
        <title>Real Estate Legal Expert in Pune | Property Documentation & Compliance | Majestic Realties</title>

        {/* Meta Description */}
        <meta
          name="description"
          content="Get expert legal support for real estate transactions, property documentation, title verification, and RERA compliance with Majestic Realties. Our legal specialists ensure transparent, secure, and hassle-free land buying near Pune."
        />

        {/* Meta Keywords */}
        <meta
          name="keywords"
          content="RERA consultant Pune, Majestic Realties legal services, Real estate legal expert Pune"
        />

        {/* Canonical URL */}
        <link rel="canonical" href="https://www.majesticrealties.com/expert-talk/legal-experts" />

        {/* Open Graph / Facebook */}
        <meta property="og:title" content="Real Estate Legal Expert in Pune | Property Documentation & Compliance | Majestic Realties" />
        <meta
          property="og:description"
          content="Get expert legal support for real estate transactions, property documentation, title verification, and RERA compliance with Majestic Realties in Pune."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.majesticrealties.com/expert-talk/legal-experts" />
        <meta property="og:site_name" content="Majestic Realties" />
        <meta property="og:image" content="URL_TO_RELEVANT_IMAGE" />

        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Real Estate Legal Expert in Pune | Property Documentation & Compliance | Majestic Realties" />
        <meta
          ...
          {`
        {
          ...
          "name": "Majestic Realties Legal Experts",
          "url": "https://www.majesticrealties.com/expert-talk/legal-experts",
          "description": "Get expert legal support for real estate transactions, property documentation, title verification, and RERA compliance with Majestic Realties. Our legal specialists ensure transparent, secure, and hassle-free land buying near Pune.",
