...
const PrivacyPolicy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Majestic Realties</title>

        <meta
          name="description"
          content="Read the official Privacy Policy of Majestic Realties. Learn how we collect, use, protect, and manage your personal data when you use our website and services."
        />

        <meta
          name="keywords"
          content="Majestic Realties Privacy Policy, data protection, real estate privacy, personal information policy, Pune real estate company, property website privacy"
        />

        {/* Canonical URL */}
        <link rel="canonical" href="https://www.majesticrealties.com/privacy-policy" />

        {/* Open Graph Meta */}
        <meta property="og:title" content="Privacy Policy | Majestic Realties" />
        <meta
          property="og:description"
          content="Learn how Majestic Realties protects your personal information and ensures secure data practices."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.majesticrealties.com/privacy-policy" />
        <meta property="og:site_name" content="Majestic Realties" />

        {/* Optional OG image */}
        <meta
          property="og:image"
          content="https://www.majesticrealties.com/assets/og-image.jpg"
        />

        {/* Twitter Meta */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Privacy Policy | Majestic Realties" />
        <meta
          name="twitter:description"
          content="Learn how Majestic Realties collects, manages, and protects your personal data."
        />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "@type": "WebPage",
            "name": "Privacy Policy",
            "url": "https://www.majesticrealties.com/privacy-policy",
            "description": "Read the official Privacy Policy of Majestic Realties.",
            "publisher": {
              "@type": "Organization",
              ...
              "logo": {
                "@type": "ImageObject",
                "url": "https://www.majesticrealties.com/assets/logo.png"
              }
            }
          }
        `}</script>
