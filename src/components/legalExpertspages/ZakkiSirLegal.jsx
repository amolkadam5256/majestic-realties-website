...
His focus is on creating transparent, legally compliant real estate transactions that protect all stakeholders and build trust in the property market.`
    ...
    return (
        <>
            <Helmet>
                {/* Page Title */}
                <title>Zakki Khan | Legal Compliance Director & RERA Expert at Majestic Realties Pune</title>

                {/* Meta Description */}
                <meta
                    name="description"
                    content="Zakki Khan, Legal Compliance Director at Majestic Realties, specializes in RERA regulations, property documentation, and legal due diligence, providing expert guidance for property buyers, investors, and developers in Pune."
                />

                {/* Meta Keywords */}
                <meta
                    name="keywords"
                    content="Zakki Khan, Majestic Realties, Legal Compliance Pune, RERA Expert Pune, Property Law Specialist, Real Estate Legal Guidance, Property Documentation, Construction Law, Consumer Protection Real Estate, Legal Due Diligence, Pune Real Estate Legal Advisor"
                />

                {/* Open Graph / Social Sharing */}
                <meta property="og:title" content="Zakki Khan | Legal Compliance Director & RERA Expert at Majestic Realties Pune" />
                <meta
                    property="og:description"
                    content="Learn from Zakki Khan's expertise in RERA compliance, property documentation, and legal due diligence for transparent and secure real estate transactions in Pune."
                />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.majesticrealties.com/zakki-khan-legal" />
                <meta property="og:image" content="https://www.majesticrealties.com/assets/zakki-khan-legal.jpg" />

                {/* Twitter Card */}
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content="Zakki Khan | Legal Compliance Director & RERA Expert at Majestic Realties Pune" />
                <meta
                    name="twitter:description"
                    content="Explore Zakki Khan's 11+ years of expertise in RERA compliance, legal documentation, and consumer protection for real estate transactions in Pune & Dubai."
                />
                <meta name="twitter:image" content="https://www.majesticrealties.com/assets/zakki-khan-legal.jpg" />
            </Helmet>
